...
### Edebi Türkçeden taşınanlar

Aşağıdaki kurallar Hüseyin Rahmi Gürpınar'ın "Sevda Peşinde" romanının (TDK basımı) yakın okumasından çıkarıldı. Kelime hazinesi eskidi, yapısal alışkanlıklar duruyor; özellikle anlatı ve hikaye içeren metinlerde uygula:

**8. Ritmi duygu eğrisine bağla.** Cümle uzunluğu rastgele değişmez, duyguyu izler: Betimleme ve sükûnette cümle uzar, şok ve karar anında üç beş kelimelik vuruşlara ve retorik soruya düşer ("Bulunduğum yere yığılakaldım. Ben nerede idim?"). Kısa cümle bu yüzden meşrudur: Sahneyi bir adım ilerletiyorsa yerindedir, poz veriyorsa kalıptır.

**9. Duyguyu bedenle göster.** "Korktu", "çok mutluydu" diye adlandırma; benzi uçsun, elleri titresin, dizleri kesilsin ("Bu markayı duyar duymaz benzi derhal uçuverdi. Ellerinde hafif bir titreme peyda oldu."). Duygu adı kullanacaksan bedensel göstergeyle çiftle; en yüksek duyguda adlandıramamak da bir araçtır ("bir şeyler oluyordu bana").
...
### 48. Koşaç Kaçışı ("X'tir" Diyememek)

**Dikkat edilecek ifadeler:** ... işlevi görmektedir, ... konumundadır, ... olarak hizmet vermektedir, ... olarak öne çıkmaktadır, ... niteliği taşımaktadır, ... olma özelliğine sahiptir, ... barındırmaktadır

**Sorun:** Model düz koşacı ("X, Y'dir", "X'te Y var") süslü fiillerle değiştirir; en basit bilgi bile tören kıyafeti giyer. Wikipedia'nın 2026 tespitlerinden: İngilizcede "is" yerine "serves as", Türkçede "-dir" yerine "işlevi görmektedir". Düz gerçek düz koşaçla söylenir.

**Önce:**
> Galeri, derneğin sergi alanı işlevi görmektedir. Bina, dört ayrı salona sahip olma özelliğiyle öne çıkmaktadır.

**Sonra:**
> Galeri, derneğin sergi alanı. Binada dört ayrı salon var.
...
**Kapanış tekdüzeliği uyarısı:** Jenerik özeti kaldırırken yerine her seferinde aynı alternatifi koymak da kalıptır; okura soru sorup "merak ediyorum" ile bitirmek üst üste birkaç metinde tekrarlanırsa etkileşim tuzağına döner. Kapanışı metnin türüne ve o metne göre seç ve seçenekleri dönüşümlü kullan: yeni somut bir bilgi veya plan, kişisel bir karar ("bundan sonra şöyle yapacağım"), bir sahne veya görüntüyle bitirme, ileriye dönük tek cümlelik tahmin, yarım bırakılmış bir düşünce, ya da gerçekten merak edilen bir soru. Aynı yazarın ardışık metinleri aynı kapanış hamlesiyle bitmemeli.
...
**Sorun:** Doğallaştırmanın kendisi de bir imza bırakabilir. Zorlama kesik cümleler, her paragrafa serpiştirilmiş "X değil. Y." yumrukları, sahte pürüzler, yapmacık argo: bu "anti-slop sicili" yeni nesil dedektörlerin ayrıca eğitildiği bir hedef (Turnitin 2025'te piyasadaki doğallaştırma araçlarının çıktısına özel tespit modülü duyurdu). İkinci tuzak, eş anlamlı değiştirmenin yeterli sanılması: kelimeleri değiştirip cümle yapısını korumak dedektörlerin ölçtüğü ritim parmak izini olduğu gibi bırakır. Piyasadaki doğallaştırma araçlarının bilinen artefaktları da bu kalıba girer; 19 aracı inceleyen DAMAGE çalışmasının (arXiv:2501.03437) taksonomisiyle: bağlama oturmayan tuhaf eşanlamlı ikamesi, metnin seviyesinin aniden düşmesi (akademik paragrafın ilkokul diline inmesi), araç artıkları ve bozulan dil bilgisi. En iyi araçlarda bile akıcılık kazanma oranı yüzde 26'da kalıyor. Doğallık ölçülü olandır; bir iki pürüz yeter, her cümle sürpriz olmak zorunda değil.
...
- **Doğal Türkçe referansı:** Yazılı Türkçenin ortalaması cümle başına 9-11 kelime, kelime başına yaklaşık 2,6 hecedir (iki bağımsız okunabilirlik çalışması aynı değerleri verir). Ortalaman bunun çok üstündeyse metin bürokratikleşmiş, çok altındaysa kesikleşmiş demektir; ama ortalamayı tuttururken varyansı öldürme (bkz. §14).
- **Okunabilirlik (Ateşman):** İstersen kaba puan hesapla: 198,825 − 40,175 × (hece/kelime) − 2,610 × (kelime/cümle). 70-89 kolay (blog, sosyal medya hedefi), 50-69 orta (kurumsal metin), 30 altı çok zor. Uzun heceli bürokratik kelime yığını puanı düşürür; "-maktadır" yüklü metinler burada da yakalanır.
- **Bağlaç oranları:** İnsan metninde zıtlık bağlacı (ama, ancak) ekleyici bağlacın (ve, de/da) yaklaşık beşte biri, açıklama bağlacı ("yani") toplamın yüzde bir ikisi kadardır. Her paragrafta bir "ancak" dönüyorsa ya da her açıklama "yani" ile geliyorsa oran bozulmuştur.
